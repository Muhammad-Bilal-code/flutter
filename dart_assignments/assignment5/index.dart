void main() {
  ...
  print("Question No 03 :  ${uniqueArr}");
  ...
  print('${arr1Length}');
  if (arr1Length > 0) {
    print('Question No 04 : array is not empty');
  } else {
    print('Question No 04 : array is empty');
  }
  ...
  print("Question No 05 : ${mergeList}");
  ...
  print("Question No 06 : ${student['name']}");
  print("Question No 06 : ${student['age']}");
  print("Question No 06 : ${student['grade']}");
  ...
  sortedList.sort();
  // print(sortedList);
  print("Question No 08 : ${sortedList.last}");
}
